	...
	<div>
		<div class="container">
			<div class="search-box">
				<el-input v-model="query.name" placeholder="角色" class="search-input mr10" clearable></el-input>
		...
		<el-dialog
			...
			@close="closeDialog"
		>
			<RoleEdit :data="rowData" :edit="idEdit" :update="updateData" @refresh="handleSaveSuccess"/>
		</el-dialog>
...
const getData = async () => {
	...
	tableData.value = res.data.sysRoleList;
    console.log("size:"+res.data.sysRoleList.length);
	pageTotal.value = 1;
};
getData();
